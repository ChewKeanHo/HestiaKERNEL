...
1>&2 printf --  "%s\n" "\
TEST CASE  :
HestiaKERNEL_OS_Is_Command_Builtin

DESCRIPTION:
Function can identify an invalid shell builtin.
"
...
___target="${LIBS_HESTIA}/HestiaKERNEL/OS/Is_Command_Builtin.sh"
...
. "$___target"
___target="$(type HestiaKERNEL_OS_Is_Command_Builtin)"
...
___output="$(HestiaKERNEL_OS_Is_Command_Builtin "$___input")"
___process=$?
