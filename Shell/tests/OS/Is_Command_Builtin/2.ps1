...
$null = Write-Host @"
TEST CASE  :
HestiaKERNEL-OS-Is-Command-Builtin

DESCRIPTION:
Function can identify an invalid cmdlet.
...
$___target = "${env:LIBS_HESTIA}\HestiaKERNEL\OS\Is_Command_Builtin.ps1"
...
$null = . $___target
if (-not (Get-Command 'HestiaKERNEL-OS-Is-Command-Builtin' -errorAction SilentlyContinue)) {
...
$___input = "Awebaergaerrgae"
$___expect = 0
$___output = HestiaKERNEL-OS-Is-Command-Builtin $___input
