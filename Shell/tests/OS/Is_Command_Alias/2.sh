...
1>&2 printf --  "%s\n" "\
TEST CASE  :
HestiaKERNEL_OS_Is_Command_Alias

DESCRIPTION:
Function can identify an invalid alias.
"
...
___target="${LIBS_HESTIA}/HestiaKERNEL/OS/Is_Command_Alias.sh"
...
. "$___target"
___target="$(type HestiaKERNEL_OS_Is_Command_Alias)"
...
___output="$(HestiaKERNEL_OS_Is_Command_Alias "$___input")"
___process=$?
