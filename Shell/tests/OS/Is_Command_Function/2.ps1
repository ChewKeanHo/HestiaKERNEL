...
$null = Write-Host @"
TEST CASE  :
HestiaKERNEL-OS-Is-Command-Function

DESCRIPTION:
Function can identify an invalid function.
...
$___target = "${env:LIBS_HESTIA}\HestiaKERNEL\OS\Is_Command_Function.ps1"
...
$null = . $___target
if (-not (Get-Command 'HestiaKERNEL-OS-Is-Command-Function' -errorAction SilentlyContinue)) {
...
$___input = "aebeargaergeag"
$___expect = 0
$___output = HestiaKERNEL-OS-Is-Command-Function $___input
