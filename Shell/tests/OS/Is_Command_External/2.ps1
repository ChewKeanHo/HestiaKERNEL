...
$null = Write-Host @"
TEST CASE  :
HestiaKERNEL-OS-Is-Command-External

DESCRIPTION:
Function can identify an invalid executable.
...
$___target = "${env:LIBS_HESTIA}\HestiaKERNEL\OS\Is_Command_External.ps1"
...
$null = . $___target
if (-not (Get-Command 'HestiaKERNEL-OS-Is-Command-External' -errorAction SilentlyContinue)) {
...
$___input = "awrbaehejrbaeb"
$___expect = 0
$___output = HestiaKERNEL-OS-Is-Command-External $___input
