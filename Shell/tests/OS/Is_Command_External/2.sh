...
___target="${LIBS_HESTIA}/HestiaKERNEL/OS/Is_Command_External.sh"
...
. "$___target"
___target="$(type HestiaKERNEL_OS_Is_Command_External)"
...
___output="$(HestiaKERNEL_OS_Is_Command_External "$___input")"
___process=$?
