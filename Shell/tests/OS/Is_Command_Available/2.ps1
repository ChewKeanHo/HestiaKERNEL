...
$null = Write-Host @"
TEST CASE  :
HestiaKERNEL-OS-Is-Command-Available
...
$___target = "${env:LIBS_HESTIA}\HestiaKERNEL\OS\Is_Command_Available.ps1"
...
$null = . $___target
if (-not (Get-Command 'HestiaKERNEL-OS-Is-Command-Available' -errorAction SilentlyContinue)) {
...
$___expect = 0
$___output = HestiaKERNEL-OS-Is-Command-Available $___input
