...
$null = Write-Host @"
TEST CASE  :
HestiaKERNEL-STRING-Split-Left
...
$___target = "${env:LIBS_HESTIA}\HestiaKERNEL\String\Split_Left.ps1"
...
$null = . $___target
if (-not (Get-Command 'HestiaKERNEL-STRING-Split-Left' -errorAction SilentlyContinue)) {
...
$___output = HestiaKERNEL-STRING-Split-Left $___input $___target
