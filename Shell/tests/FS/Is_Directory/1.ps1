...
DESCRIPTION:
Function can identify a proper file path.
...
$___target = "${env:LIBS_HESTIA}\HestiaKERNEL\FS\Is_Directory.ps1"
...
$___input = "${env:LIBS_HESTIA}\HestiaKERNEL\FS\Is_Directory.ps1"
$___expect = 0
