...
. "${env:LIBS_HESTIA}\HestiaKERNEL\Unicode\Replace-Any_Right_Unicode.ps1"
. "${env:LIBS_HESTIA}\HestiaKERNEL\Unicode\To_Unicode_From_String.ps1"




function HestiaKERNEL-Replace-Any-Right-String {
        param (
                [string]$___input,
                [string]$___from,
                [string]$___to,
        ...
        $___content = HestiaKERNEL-Replace-Any-Right-Unicode $___content `
                                                        $___chars_from `
                                                        $___chars_to `
                                                        $___count `
                                                        $___ignore
